                        ...
                        <div className="w-[400px]">
                            <div className="mb-3">
                                ...
                                <div className="relative duration-200">
                                    ...
                                    <input name="hoTen" type="text" onChange={formik.handleChange} value={formik.values.hoTen} className="bg-gray-600 border text-white text-sm rounded-lg border-none block w-full pl-10 p-2.5" />
                            ...
                            <div className="mb-3">
                                ...
                                <div className="relative">
                                    ...
                                    <input name="taiKhoan" type="text" onChange={formik.handleChange} value={formik.values.taiKhoan} className="bg-gray-600 border text-white text-sm rounded-lg border-none block w-full pl-10 p-2.5" />
                            ...
                            <div className="mb-3">
                                ...
                                <div className="relative">
                                    ...
                                    <input name="matKhau" type="text" onChange={formik.handleChange} value={formik.values.matKhau} className="bg-gray-600 border text-white text-sm rounded-lg border-none block w-full pl-10 p-2.5" />
                            ...
                            <div className="mb-3">
                                ...
                                <div className="relative">
                                    ...
                                    <input name="maLoaiNguoiDung" type="text" onChange={formik.handleChange} value={formik.values.maLoaiNguoiDung} className="bg-gray-600 border text-white text-sm rounded-lg border-none block w-full pl-10 p-2.5" disabled />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-[400px]">
                            <div className="mb-3">
                                ...
                                <div className="relative">
                                    ...
                                    <input name="email" type="text" onChange={formik.handleChange} value={formik.values.email} className="bg-gray-600 border text-white text-sm rounded-lg border-none block w-full pl-10 p-2.5" />
                            ...
                            <div className="mb-3">
                                ...
                                <div className="relative">
                                    ...
                                    <input name="soDT" type="text" onChange={formik.handleChange} value={formik.values.soDT} className="bg-gray-600 border text-white text-sm rounded-lg border-none block w-full pl-10 p-2.5" />
                                </div>
                            </div>
                            <div className="mb-3">
                                ...
                                <div className="relative">
                                    ...
                                    <input name="maNhom" type="text" onChange={formik.handleChange} value={formik.values.maNhom} className="bg-gray-600 border text-white text-sm rounded-lg border-none block w-full pl-10 p-2.5" disabled />
                                </div>
                            </div>
                        </div>
                    </div>
