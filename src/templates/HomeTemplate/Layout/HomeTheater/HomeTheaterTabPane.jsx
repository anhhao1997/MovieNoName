...
export default function HomeTheaterTabPane(props) {
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 ">
                                        {cumRap.danhSachPhim.slice(0, 10).map((phim, index) => {
                                            return (
                                                <div className="grid grid-cols-3 w-full h-full m-1 p-2 gap-2 text-xs font-semibold border-b-2 border-gray-200 transition ease-in-out delay-150 hover:shadow-md shadow-black hover:scale-105 duration-300 hover:border-2 relative" key={index}>
                                                    {/* hinhAnhPhim */}
    ...
    return (
        <div name="heThongRap" className="w-full py-10">
